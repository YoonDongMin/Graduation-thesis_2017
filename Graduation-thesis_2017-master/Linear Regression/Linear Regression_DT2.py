...
xy1 = np.loadtxt('DT1.csv', delimiter=',', dtype=np.int32)
xy2 = np.loadtxt('DT2.csv', delimiter=',', dtype=np.int32)
sale = np.loadtxt('Sale_Data.csv', delimiter=',')

y_data1 = xy1[500:700, [-1]]
real1 = sale[500:700]

y_data2 = xy2[500:700, [-1]]
real2 = sale[500:700]

Loss_compare(y_data1, real1, 30)
BT1 = y_data1 - real1
BT1 =  np.std(BT1)
print(BT1)

Loss_compare(y_data2, real2, 30)
BT2 = y_data2 - real2
BT2 =  np.std(BT2)
print(BT2)
